...
import UserManagerRightSlideContent from './UserManagerRightSlideContent'


class UserManager extends React.Component {
    constructor(...args){
        super(...args)
        this.state = UserManagerData
        this.state.columns = UserManagerData.columns.slice()
        console.log(this.state.columns === UserManagerData.columns)
        this.state.columns.push({
            label: "操作",
            width: 200,
            render: ()=>{
                return <span><Button type="text" onClick={this.openRightSilde} size="small">移除</Button></span>
            }
        })
        console.log(this.state.columns === UserManagerData.columns)
        this.openRightSilde = this.openRightSilde.bind(this)
    }

    openRightSilde(){
        this.refs.rightSlide.trigger()
    }
    ...
    render() {
        return <div className="yzt-container">
                ...
                <RightSlide ref="rightSlide"><UserManagerRightSlideContent/></RightSlide>
            </div>
    }
}
